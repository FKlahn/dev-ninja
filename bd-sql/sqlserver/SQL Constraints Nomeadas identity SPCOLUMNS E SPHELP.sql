...
DESC, SHOW CREATE TABLE MySQL
*/

/*SQL - PROCEDURES - JÁ CRIADAS E ARMAZENADAS NO SISTEMA*/
...
SELECT * FROM ALUNO A LEFT JOIN TELEFONE T ON A.IDALUNO = T.ID_ALUNO
GO
...
FROM 'C:\Program Files\CONTAS.txt'
WITH
(
	FIRSTROW = 2,
	DATAFILETYPE = 'char',
...
AS
	...
	SET @FK = (SELECT IDPESSOA FROM PESSOA WHERE IDPESSOA = @@IDENTITY) --GUARDA O ULTIMO IDENTITY INSERIDO NA SEÇÃO
