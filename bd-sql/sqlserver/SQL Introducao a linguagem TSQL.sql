...
PODENDO SER ANÔNIMO OU NÃO
BLOCOS ANONIMOS NÃO RECEBEM NOME, POIS NÃO SÃO SALVOS NO BANCO.
CRIAMOS BLOCOS ANÔNIMOS QUANDO IREMOS EXECUTÁ-LOS UMA SÓ VEZ OU TESTAR ALGO*/
...
--A variavel contador está delimitada pelo go
...
--CONVERT É MAIS UTILIZADO PARA DATAS E CAST É UTILIZADO NORMALMENTE PARA OS DEMAIS TIPOS
...
DECLARE
	@NUMERO INT = 5
BEGIN
	IF @NUMERO = 5 --EXPRESSÃO BOOLEANA - V OU F
...
BEGIN
	...
	CASE --NÃO É EXATAMENTE UMA CLAUSULA DE PROGRAMAÇÃO
